...
namespace Obvs.AzureServiceBus.Configuration {
    ...
    public class MessageTypeMessagingEntityMappingDetails {
        ...
        public MessageTypeMessagingEntityMappingDetails(Type messageType, string path, MessagingEntityType messagingEntityType) : this(messageType, path, messagingEntityType, MessagingEntityCreationOptions.None) { }

        public MessageTypeMessagingEntityMappingDetails(Type messageType, string path, MessagingEntityType messagingEntityType, MessagingEntityCreationOptions creationOptions) : this(messageType, path, messagingEntityType, creationOptions, ReceiveMode.ReceiveAndDelete) { }

        public MessageTypeMessagingEntityMappingDetails(Type messageType, string path, MessagingEntityType messagingEntityType, MessagingEntityCreationOptions creationOptions, ReceiveMode receiveMode) {
